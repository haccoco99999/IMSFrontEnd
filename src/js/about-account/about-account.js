...
class Account extends React.Component {
    ...
    clickSaveEdit () {
        ...
        if ((this.state.isConfirmPassword && this.state.isValidPassword) || this.state.isEdit) {
            var dataUpdate = {
            ...
            this.props.updateRequest({ token: this.props.client.token, dataUpdate: dataUpdate })
                    ...
                    <div>
                                ...
                                <div className="modal-content customize-model-content">
                                    ...
                                    <div className="modal-body">
                                        ...
                                        <div className="form-group">
                                            ...
                                            <input type="text" onChange={(event) => this.changeConfirmPassword(event)} ref={this.password} className="form-control" placeholder="" />

                                        </div>
                                        <div className="form-group">
                                            <label >NEW PASSWORD</label>
                                            <input onChange={(event) => this.changeConfirmPassword(event)} ref={this.newPassword} type="text" className="form-control" placeholder="" />
                                            <small class={"valid-password-" + this.state.isValidPassword}>Minimum eight characters,uppercase letter, owercase letter,number and special characte</small>
                                        </div>
                                        <div className="form-group">
                                            <label >CONFIRM PASSWORD</label>
                                            <input onChange={(event) => this.changeConfirmPassword(event)} ref={this.confirmPassword} type="text" className="form-control" placeholder="" />
                                            <small class={"valid-confirm-password-" + this.state.isConfirmPassword}>Please make sure your password match</small>
                                        </div>

                                    </div>
                                    <div className="modal-footer">
                                        <button type="button" className="btn btn-secondary" onClick={this.clickModal}>Cancel</button>
                                        <button type="button" className="btn btn-primary" onClick={this.clickSaveEdit} >Done</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="container-account">
                            <div className="name-avatar-account">
                                <img className="avatar-img" src="https://i.pinimg.com/736x/76/07/5c/76075c11bfe509ee9a11d9baa991c40d.jpg" alt="avatar" />
                            ...
                            {!this.state.isEdit ? <p className="edit-profile" onClick={this.clickEdit}>Edit</p> : <div> <p className="edit-profile" onClick={this.clickSaveEdit} >Save</p>
                                <p className="edit-profile" onClick={this.clickCancelEdit} >Cancel</p></div>}
                            ...
                            <div className="container-edit-account">
                                ...
                                <div className="form-info">
                                    ...
                                    <input type="text" name="fullname" value={this.state.isEdit ? this.state.fullname : this.props.client.fullname} onChange={(event) => this.onChangeValue(event)} className={"input-edit-profile edit-profile-" + this.state.isEdit} />
                                ...
                                <div class="form-info">
                                    <label>Phone</label>
                                    <input type="text" name="phoneNumber" value={this.state.isEdit ? this.state.phoneNumber : this.props.client.phoneNumber} onChange={(event) => this.onChangeValue(event)} className={"input-edit-profile edit-profile-" + this.state.isEdit} />
