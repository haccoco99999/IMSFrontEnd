...
export default function PreviewPriceQuote (props) {
                ...
                <div class="modal-dialog modal-dialog-centered modal-dialog-preview-quote-request">
                    <div class="modal-content modal-content-preview-quote-request">
                        <div class="modal-header">
                            ...
                            <button type="button" onClick={() =>dispatch(clickToPrevewPriceQuote())} class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        ...
                        <div class="modal-footer">
                            <button type="button" onClick={() =>dispatch(clickToPrevewPriceQuote())} class="btn btn-secondary btn-cancel-preview" data-bs-dismiss="modal">Cancel</button>
                            <button type="button" onClick={()=> { dispatch(clickToPrevewPriceQuote()),
                                dispatch(clickToSendMailPriceQuote())}} class="btn btn-primary">Send email to vendor</button>
                        </div>
                    </div>
                </div>
            </div>
