            ...
            <nav className={"hide-" + this.state.statusSetting}>
              ...
              <li>
                <Link to="/homepage/purchase" >
                  <i className="bx"><img src="src\js\images\shopping-2.png" /></i>
              ...
              <li>
                <Link to="/homepage/stock-take" >
                  <i className="bx"><img src="src\js\images\shelf-2.png" /></i>
              ...
              <li>
                <Link to="/homepage/report" >
                  <i className="bx"><img src="src\js\images\report-2.png" /></i>
              ...
              <li>
                <Link to="/homepage/product" >
                  <i className="bx"><img src="src\js\images\product-2.png" /></i>
              ...
              <li>
                <Link to="/homepage/supplier" >
                  <i className="bx"><img src="src\js\images\manufacture-2.png" /></i>
