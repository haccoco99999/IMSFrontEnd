...
import {
  ...
  SearchToAddProduct,
} from "../../search-component/SearchComponentAll";
...
export default function FormAddProductModal(props) {
  ...
  async function getListProduct(keySearch) {
    ...
    setListGroupNameProduct(
      json.paging.resultList.map((product) => {
        return {
          isChecked: false,
          haveProduct: false,
  ...
  async function getListProductVariant(productId, index) {
    ...
    setListGroupNameProduct((state) =>
      state.map((element, i) =>
        i === index
          ? {
              ...element,
              haveProduct: true,
              listProductVariant: json.product.productVariants.map(
                (productVariant) => {
                  return {
  ...
  function selectGroupProduct(event, index, haveProduct, orderId) {
    ...
    if(haveProduct){ getListProductVariant(orderId, index)};
  }
          ...
          <div className="modal-content modal-content-merge-pirce-quote">
              ...
              {/* <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                  <button
                    ...
                    name="addOneProduct"
                    class="nav-link show active customize-nav-tabs"
                    id="nav-home-tab"
                    data-bs-toggle="tab"
                          ...
                          <div>
                            ...
                            <div id={"collapsediv" + index} class="collapse">
                              <table class="table">
                                ...
                                <tbody>
                                  {product.listProductVariant.map(
            ...
            <div className="modal-footer">
              ...
              <button
                ...
                onClick={() =>
                  eventNavTabs.addOneProduct
                    ? props.clickToAddProduct(product)
