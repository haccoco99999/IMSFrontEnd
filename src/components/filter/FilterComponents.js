            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div className="row">
                        <div class="form-group">
                            <label for="">Search:</label>
                            <input type="text" value={props.filter.searchQuery} onChange={props.onChangeValueFilter} placeholder={props.placeholderSearch}
                                class="form-control" name="searchQuery" id="" aria-describedby="helpId"  />
